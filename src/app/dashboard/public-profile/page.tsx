  ...
  return (
    <div className="mx-auto lg:ml-3 mt-3 w-full sm:w-11/12 md:w-4/5 lg:w-5xl xl:w-6xl bg-white shadow-xl rounded-lg overflow-hidden">
      ...
      >
        ...
        <div className="absolute bottom-4 right-4 sm:right-1 lg:right-6 flex flex-col space-y-1 sm:flex-row sm:space-x-4 sm:space-y-0 text-xs sm:text-sm opacity-90">
          <p>Created 1 Brand</p>
          <p>Contributed 2 Brands</p>
        </div>
      </header>
      <div className="relative px-6 -mt-14 sm:-mt-16 pb-4 flex items-end">
        ...
        <div className="ml-4 sm:ml-6 flex-grow flex items-center justify-between pt-12 sm:pt-16">
          <span className="text-lg sm:text-xl font-bold text-gray-800">
            {userName}
          </span>
        </div>
      </div>
      <nav className="border-b border-gray-200 mt-2 px-6 overflow-x-auto">
        <div className="flex space-x-4 sm:space-x-8 min-w-max">
          {["brands", "contributions", "about"].map((t) => (
            <a
              ...
              className={`py-3 text-sm sm:text-base font-semibold uppercase tracking-wide transition duration-150 ease-in-out ${
                tab === t
